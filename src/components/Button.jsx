...
function Button({
    ...
    const style = {
        ...
        borderRadius: borderRadius === "none" ? "0px" : borderRadius === "small" ? "4px" : borderRadius === "large" ? "16px" : "8px",
        width: width || "auto",
        opacity: disabled ? 0.5 : pressed ? 0.8 : 1,
        cursor: disabled ? "not-allowed" : "pointer",
        pointerEvents: disabled ? "none" : "auto", ...customStyle,
    };
    ...
    return (<>
            ...
            >
                ...
                {animeIcon && (<span style={{ ...spinStyle, marginRight: label ? "6px" : 0 }}>{animeIcon}</span>)}
